                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-gray-50 p-6 rounded-lg sticky top-24">
                                ...
                                <button
                                    ...
                                    disabled={isPaying}
                                    className="w-full bg-[#25D366] text-white text-center py-4 rounded-full font-bold text-lg hover:bg-[#128C7E] transition shadow-lg flex items-center justify-center gap-2"
                                >
